  ...
  return (
    ...
    <div className="carousel-inner">
      ...
      <div className="carousel-item overflow-auto text-center" data-bs-interval="5000">
       <h2>For Providers</h2>
       <p className='text-block'>SWASTHa gives you an opportunity to serve the world with ur skills and experience and help us in our initiative of serving the best to the world.
