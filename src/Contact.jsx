...
const Contact = () => {
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-10 mx-auto">
              ...
              <h1 className="techcare">SWASTHa •</h1>
                <h1>
    ...
    <div className="carousel-inner">
      ...
      <h2 className='text-center'>SWASTHa</h2>
   
      <p className='text-block'>Our customer care service is commited to resolve your queries 24*7.<br/><NavLink className='carousel-btns' to='about'>About Us</NavLink></p>
